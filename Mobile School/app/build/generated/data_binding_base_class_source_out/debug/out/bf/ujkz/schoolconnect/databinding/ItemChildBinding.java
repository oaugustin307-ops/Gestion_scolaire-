...
public final class ItemChildBinding implements ViewBinding {
  ...
  private ItemChildBinding(@NonNull MaterialCardView rootView, @NonNull ShapeableImageView imgPhoto,
      @NonNull TextView tvClass, @NonNull TextView tvName) {
  ...
  public static ItemChildBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemChildBinding((MaterialCardView) rootView, imgPhoto, tvClass, tvName);
    }

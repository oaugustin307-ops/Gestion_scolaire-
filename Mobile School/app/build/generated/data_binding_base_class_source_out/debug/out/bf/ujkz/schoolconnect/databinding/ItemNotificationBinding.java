...
public final class ItemNotificationBinding implements ViewBinding {
  ...
  private ItemNotificationBinding(@NonNull MaterialCardView rootView, @NonNull TextView tvDate,
      @NonNull TextView tvMessage, @NonNull TextView tvPriority, @NonNull TextView tvTitle) {
  ...
  public static ItemNotificationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemNotificationBinding((MaterialCardView) rootView, tvDate, tvMessage, tvPriority,
          tvTitle);
    }

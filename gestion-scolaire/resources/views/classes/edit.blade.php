...
<div class="max-w-2xl mx-auto">
    <h1 class="text-2xl font-bold mb-6">Modifier Classe</h1>
    ...
    <form action="{{ route('classes.update', $class) }}" method="POST" class="bg-white rounded-lg shadow p-6">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" value="{{ old('name', $class->name) }}" required class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
            @error('name') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
        </div>

        <div class="mb-4">
            <label class="block text-gray-700 text-sm font-bold mb-2">Niveau</label>
            <input type="text" name="level" value="{{ old('level', $class->level) }}" required class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="school_fees" value="{{ old('school_fees', $class->school_fees) }}" step="0.01" required class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
